                                            ...
                                            <form action="" className='w-full' onSubmit={handleSubmit(handleUpdateProperty)}>
                                                    ...
                                                    <div className='flex flex-col '>
                                                        <div className='my-1'>
                                                            ...
                                                            <input type="text" id="Title" name="Title"
                                                                className="w-full px-4 py-2 border border-gray-400 rounded-md focus:ring-2 focus:border-none focus:ring-blue-500 focus:outline-none" defaultValue={data?.title} {...register('title')} />
                                                        ...
                                                        <div className='my-1'>
                                                            ...
                                                            <input type="number" id="Price" name="Price"
                                                                className="w-full px-4 py-2 border border-gray-400 rounded-md focus:ring-2 focus:border-none focus:ring-blue-500 focus:outline-none" defaultValue={data?.price} {...register('price')} />
                                                        ...
                                                        <div className='my-1'>
                                                            ...
                                                            <input type="text" id="Area" name="Area"
                                                                className="w-full px-4 py-2 border border-gray-400 rounded-md focus:ring-2 focus:border-none focus:ring-blue-500 focus:outline-none" defaultValue={data?.area} {...register('area')} />
                                                    ...
                                                    <div className='flex flex-col '>
                                                        <div className='my-1'>
                                                            ...
                                                            <input type="text" id="ApartmentType" name="ApartmentType"
                                                                className="w-full px-4 py-2 border border-gray-400 rounded-md focus:ring-2 focus:border-none focus:ring-blue-500 focus:outline-none" defaultValue={data?.apartmentType} {...register('apartmentType')} />
                                                        ...
                                                        <div className='my-1'>
                                                            ...
                                                            <input type="text" id="Landmark" name="Landmark"
                                                                className="w-full px-4 py-2 border border-gray-400 rounded-md focus:ring-2 focus:border-none focus:ring-blue-500 focus:outline-none" defaultValue={data?.landmark} {...register('landmark')} />
                                                        ...
                                                        <div className='my-1'>
                                                            ...
                                                            <input type="text" id="Googlemap" name="Googlemap"
                                                                className="w-full px-4 py-2 border border-gray-400 rounded-md focus:ring-2 focus:border-none focus:ring-blue-500 focus:outline-none" defaultValue={data?.googlemap} {...register('googlemap')} />
                                                ...
                                                <div className='grid grid-cols-1'>
                                                    <div className='my-1'>
                                                        ...
                                                        <textarea type="text" id="ApartmentType" name="Description"
                                                            className="w-full px-4 py-2 border border-gray-400 rounded-md focus:ring-2 focus:border-none focus:ring-blue-500 focus:outline-none" defaultValue={data?.description} {...register('description')} />
