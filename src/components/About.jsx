                ...
                <div className=" rounded-2xl h-full bg-gray-100 ">
                    <div className='px-10 pt-10 pb-10'>
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-10 min-h-70 gap-15'>
                            ...
                            <div className=' flex flex-col p-0 '>
                                <div className=' w-auto'>
                                    <i className="fa-solid fa-tag fa-2x  border-4 border-gray-300" style={{ borderRadius: "36px", padding: "15px 17px" }} />
                                </div>
                            ...
                            <div className=' flex flex-col p-0 '>
                                <div className=' w-auto'>
                                    <i className="fa-solid fa-stopwatch fa-2x  border-4 border-gray-300 p-4 " style={{ borderRadius: "36px", padding: "15px 17px" }} />
                                </div>
                                <h1 className='my-3 text-lg font-semibold'>Experienced</h1>
                            ...
                            <div className=' flex flex-col p-0 '>
                                <div className=' w-auto'>
                                    <i className="fa-solid fa-shield-halved fa-2x  border-4 border-gray-300 p-4 " style={{ borderRadius: "36px" }} />
                                </div>
